...
> Por favor espere...` }, { quoted: m })
    ...
    const thumbBuffer = Buffer.from(await (await fetch('https://i.postimg.cc/prym5tmP/IMG-20251026-WA0001.jpg', 'https://i.postimg.cc/5yFxM9HZ/IMG-20251026-WA0003.jpg')).arrayBuffer())
